			...
			<tr>
				...
				<td class="WidgetStatus-left">
					<table style="width:100%">
						<tr>
							<td class="WidgetStatus-left">
								<input class="bar" value="'.$CmdDeviceValue.'" type="range" step="0.5" min="'.$TheremostatMin.'" max="'.$TheremostatMax.'" Cmd_device_Id="'.$Cmd_device_Id.'" Device_id ="'.$Device_id.'" name="Range_'.$NomWithoutSpace.'_'.$LieuxWithoutSpace.'"  id="Range_'.$NomWithoutSpace.'_'.$LieuxWithoutSpace.'_'.$Cmd_device_Id.'" data-type="'.$Cmd_type.'" data-role="'.$WidgetType.'" oninput="$(InfoDevice'.$NomWithoutSpace.'_'.$LieuxWithoutSpace.'_'.$Cmd_device_Id.').html(this.value);$(InfoDevice'.$NomWithoutSpace.'_'.$LieuxWithoutSpace.'_'.$Cmd_device_Id.').attr(\'value\',this.value)"/>
							</td>
						</tr>
					</table>
				</td>

...
<script>
	function initDataTable(table_name = 'empty') {
		...
		//region datatable room
		if (table_name == '' || table_name == 'Room') {
		...
		//region datatable sante

		if (table_name == '' || table_name == 'Health') {
		...
		//region datatable log

		if (table_name == '' || table_name == 'Log') {
		...
		if (table_name == '' || table_name == 'Plugins') {
	...
	function LoadEquipement() {
		LoadLieux();
		/*$("#table-content-equipement").dataTable().fnClearTable();
		$("#table-content-equipement").DataTable().ajax.reload();
		$("#table-content-equipement").dataTable().resize();*/
		...
		$('#table-content-equipement tbody').unbind('click').on('click', '.EquipementVisible', function() {
				...
				Device = $.param({
					...
					LieuxId: DeviceData.LieuxId,
					ModuleId: DeviceData.ModuleId,
					ModelTypeId: DeviceData.TypeId,
					DeviceName: DeviceData.DeviceNom,
					CarteDeviceId: DeviceData.Cmd_Device_DeviceId,
					CarteId: DeviceData.CarteId,
					RAZ: DeviceData.RAZ,
					DeviceVisible: DeviceData.DeviceVisible,
					CmdDeviceid: DeviceData.Cmd_device_Id
				})
